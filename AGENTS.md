...
## 🛡️ Safety & Security
- **Forbidden Files (Hard Boundary):** NEVER read, modify, or delete `.env` files or their variations (`.env.local`, `.env.production`, etc.). Refer to [security.md](.agents/rules/security.md) for strict protocols.
