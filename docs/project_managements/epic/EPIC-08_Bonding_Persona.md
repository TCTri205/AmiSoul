...
- [x] **Bonding Service:** Hiện thực hóa công thức tính `Bonding_Delta` với các trọng số cảm xúc và tần suất tương tác.
- [x] **DPE (Dynamic Persona Evolution):** Tự động điều chỉnh System Prompt dựa trên `Bonding_Level` (từ Stranger đến Soulmate).
- [x] **Implicit Feedback:** Phân tích các tín hiệu ngầm như tốc độ trả lời tin nhắn để điều chỉnh điểm số.
- [x] **Weekly Decay:** Triển khai cơ chế giảm điểm nhẹ nếu người dùng không tương tác trong thời gian dài.
- [x] **Special Date Recognition:** AI chủ động nhắc lại hoặc chúc mừng các sự kiện quan trọng trong quá khứ.
...
- **[T8.3: Implicit Feedback Loop](../ticket/Sprint-08/T8.3_Implicit_Feedback_Loop.md)**
