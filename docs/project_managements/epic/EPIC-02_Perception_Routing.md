...
- [ ] **Perception Service:** Tích hợp thành công Multi-Model Provider (Groq/Gemini) với cơ chế xoay vòng API Key.
...
- **[T2.8: Multi-Model Rotation](../ticket/Sprint-02/T2.8_Multi_Model_Rotation.md)**
